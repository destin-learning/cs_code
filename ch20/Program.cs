...
namespace ch4
{
    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            while(done==false)
            {
                ...
                switch (iselection) // 12.1
                {
                    ...
                    // this will demonstrate how to use date functions in C# 	 
                    case 6: 										 
                    {
                        DateDemo();
                        break;
        ...
        // demonstrate how to use date functions in C#
        public static void DateDemo()
        {
            // 19.1 create a new date October 23, 2017
            DateTime my_date = new DateTime(2017, 10, 23);
 
            // 19.2 print out the date time in a custom format
            System.Console.WriteLine("The date is: "+ my_date.ToString("MMMM dd, yyyy"));
 
            // 19.3 return just the month component
            System.Console.WriteLine("my_date month: " + my_date.Month);
 
            // 19.4 return just the day component
            System.Console.WriteLine("my_date day of the month: " + my_date.Day);
 
            // 19.5 get the day of the week
            System.Console.WriteLine("my_date day of the week: " + my_date.DayOfWeek);
 
            // 19.6 get the day of the week
            System.Console.WriteLine("my_date day of the year: " + my_date.DayOfYear);
 
            // 19.7 create a new date
            DateTime new_date = new DateTime(2017, 10, 28);
 
            // 19.8 get the number of days between these dates
            int diff;
            diff = (new_date - my_date).Days;
            System.Console.WriteLine("The number of days between: " + diff);
